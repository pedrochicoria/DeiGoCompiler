...
define i32 @main() {
	...
	%call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i32 1123)
...
@.str.3 = private unnamed_addr constant [5 x i8] c"asd\0A\00", align 1
